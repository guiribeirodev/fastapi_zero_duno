...
## Sobre o Projeto
O Fast Zero é uma aplicação web desenvolvida com FastAPI. O projeto utiliza PostgreSQL como banco de dados relacional, SQLAlchemy como ORM, gerenciamento de migrações com Alembic e controle de dependências através do Poetry. 
